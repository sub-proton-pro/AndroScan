...
def build_system_content() -> str:
    ...
    return (
        ...
        "When specifying extras keys, always use the actual full string literal "
        "(e.g. \"com.example.app.EXTRA_PIN\"), never a Java/Kotlin constant name "
        "(e.g. NOT \"Constants.EXTRA_PIN\" or \"EXTRA_PIN\"). "
        "Derive the real value from the decompiled source or manifest.\n"
