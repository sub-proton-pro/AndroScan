...
- status: Active *(planning checkpoint 11.0 ratified 2026-04-30; implementation pending sub-steps 11.1 → 11.7 + parallel CI.0 thread per `docs/TASKS.md` § Phase 11 — Behavior Trace v2 — sub-step backlog)*
- date: 2026-04-30
- owners: (project)
- context:
